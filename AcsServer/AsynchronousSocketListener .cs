...
public class StateObject
{
        ...
        public static void StartListening()
    {
        ...
        //IPAddress ipAddress = IPAddress.Parse("135.254.167.145");
        IPAddress ipAddress = IPAddress.Parse("127.0.0.1");
        IPEndPoint localEndPoint = new IPEndPoint(ipAddress, 32626);
        ...
        try
        {
            ...
            while (true)
            {
                ...
                applog.loggen("Waiting for a connection...");
        ...
        public static void ReadCallback(IAsyncResult ar)
        {
            ...
            if (bytesRead > 0)
            {
                ...
                if (content.IndexOf("<EOF>") > -1)
                {
                    ...
                    applog.loggen(string.Format("Read {0} bytes from socket. \n Data : {1}",
        ...
        private static void SendCallback(IAsyncResult ar)
        {
            try
            {
                ...
                applog.loggen(string.Format("Sent {0} bytes to client.", bytesSent));
